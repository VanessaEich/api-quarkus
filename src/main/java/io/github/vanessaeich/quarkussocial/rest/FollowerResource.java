...
import io.github.vanessaeich.quarkussocial.rest.dto.FollowerRequest;
import io.github.vanessaeich.quarkussocial.rest.dto.FollowerResponse;
import io.github.vanessaeich.quarkussocial.rest.dto.FollowersPerUserResponse;
    ...
    public Response followUser( @PathParam("userId") Long userId, FollowerRequest request){
        ...
        if(userId.equals(request.getFollowerId())){
            return Response.status(Response.Status.CONFLICT)
                    .entity("Você não pode serguir a si mesmo").build();
        }
